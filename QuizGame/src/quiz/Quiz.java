...
public class Quiz implements ActionListener{
	...
	String[][] options= {
			                          ...
			                          {"Amazon River","Nile River","Ganga River","Yangtze River"},
			                          {"Andes","Rockies","Alps","Himalayas"},
			                          {"Sahara Desert","Arabian","Gobi","Kalhari"},	
	                                };
	
	char[] answers =     {'C','C','B','D','A'};
	...
	public Quiz() {
		...
		time_label.setFont(new Font("Calibri",Font.BOLD,25));
		...
		number_right.setFont(new Font("Calibri",Font.BOLD,50));
